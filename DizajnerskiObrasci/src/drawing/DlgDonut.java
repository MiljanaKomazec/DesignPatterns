...
public class DlgDonut extends JDialog {
	...
	public DlgDonut() {
		...
		}
		{
			...
			lblInnerRadius.setBackground(new Color(255, 240, 245));
		...
		{	
			...
			txtInnerRadius.setBackground(new Color(51, 204, 0));
					...
					public void actionPerformed(ActionEvent arg0) 
					{
						try
						{
							...
							if (newX < 0 || newY < 0 || newInnerRadius < 1 || newRadius < 1 )
							{
								...
								Donut d = new Donut( new Point(newX, newY), newRadius, newInnerRadius, false, borderFill, innerFill);
								confirmation = true;
								dispose();
								}
							if(newInnerRadius >= newRadius)
							{
								JOptionPane.showMessageDialog(null, "Inner radius can not be equal to or greater than radius", "Error", JOptionPane.ERROR_MESSAGE);
							}else {
							Donut d = new Donut( new Point(newX, newY), newRadius, newInnerRadius, false, borderFill, innerFill);
							confirmation = true;
							dispose();
